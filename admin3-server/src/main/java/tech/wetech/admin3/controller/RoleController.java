...
public class RoleController {
  ...
  public ResponseEntity<PageDTO<RoleUserDTO>> findRoleUsers(
  ...
  public ResponseEntity<Role> createRole(@RequestBody @Valid RoleRequest request) {
    return new ResponseEntity<>(
        roleService.createRole(request.name(), request.description()), HttpStatus.CREATED);
  }

  @RequiresPermissions("role:update")
  @PutMapping("/{roleId}/resources")
  public ResponseEntity<Role> changeResources(
      @PathVariable Long roleId, @RequestBody @Valid RoleResourceRequest request) {
  ...
  public ResponseEntity<Role> changeUsers(
      @PathVariable Long roleId, @RequestBody @Valid RoleUserRequest request) {
  ...
  public ResponseEntity<Role> updateRole(
      @PathVariable Long roleId, @RequestBody @Valid RoleRequest request) {
